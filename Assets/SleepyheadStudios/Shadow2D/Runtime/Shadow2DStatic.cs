...
{
    /// <summary>
    /// Static shadow component for non-animated objects (grass, props, decorations).
    /// Only updates when sprite changes, not every frame - massive performance improvement!
    /// </summary>
    [RequireComponent(typeof(SpriteRenderer))]
    public class Shadow2DStatic : MonoBehaviour
    {
        ...
        {
            return parentSpriteRenderer.sprite != lastSprite ||
                   parentSpriteRenderer.flipX != lastFlipX ||
                   parentSpriteRenderer.flipY != lastFlipY ||
                   parentSpriteRenderer.sortingOrder != lastSortingOrder;
        }

        private void CacheCurrentState()
        {
            lastSprite = parentSpriteRenderer.sprite;
            lastFlipX = parentSpriteRenderer.flipX;
            lastFlipY = parentSpriteRenderer.flipY;
            lastSortingOrder = parentSpriteRenderer.sortingOrder;
        }
        ...
        /// <summary>
        /// Update shadow sprite to match parent (call manually when needed)
        /// </summary>
        ...
        public void CreateShadow()
        {
            ...
            if (parentSpriteRenderer == null)
            {
                Debug.LogError("No SpriteRenderer found! Shadow2DStatic requires a SpriteRenderer component.");
                return;
            }
